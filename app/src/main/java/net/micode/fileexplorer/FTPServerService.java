...
public class FTPServerService extends Service implements Runnable {
    ...
    private void setupNotification() {
        ...
        **/
        ...
        CharSequence contentTitle_1 = getString(R.string.notif_title);
        CharSequence contentText_1 = "";
        InetAddress address_1 = FTPServerService.getWifiIp();
        if (address_1 != null) {
            String port = ":" + FTPServerService.getPort();
            contentText_1 = "ftp://" + address_1.getHostAddress() + (FTPServerService.getPort() == 21 ? "" : port);
        }


        Intent notificationIntent_1 = new Intent(this, FileExplorerTabActivity.class);
        notificationIntent_1.putExtra(GlobalConsts.INTENT_EXTRA_TAB, 2);
        PendingIntent contentIntent_1 = PendingIntent.getActivity(this, 0, notificationIntent_1, 0);

        Notification notification_1 = new Notification.Builder(getApplicationContext())
                .setContentTitle(contentTitle_1)
                .setContentText(contentText_1)
                .setContentIntent(contentIntent_1)
                .build();
        startForeground(123453,notification_1);
